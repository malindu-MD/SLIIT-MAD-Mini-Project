...
import com.example.myapplication.adapters.BuyerAdapter
import com.example.myapplication.models.Buyer
...
class Buyer_Items_List : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        logOut.setOnClickListener {
            val intent = Intent(this, SplashScreenSarubima::class.java)
            startActivity(intent)
            finish()
        }
    }
